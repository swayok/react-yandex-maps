!(function(e, t) {
  ...
  var E =
    ...
    P = function(e) {
      var t = _(e),
        o = function(o) {
          return n.createElement(T.Consumer, null, function(r) {
            if (null === r)
              throw new Error(
    ...
    M = function(e) {
      var t = function(t) {
        return n.createElement(x.Consumer, null, function(o) {
  ...
  var Se = M(k(we, !0, ['control.TypeSelector']));
  function Re(e) {
  ...
  var Ee = M(k(Re, !0, ['control.ZoomControl'])),
    Ce = (function(e) {
      function t() {
        e.call(this), (this.state = { instance: null });
      }
  ...
  Me.features = j.arrayOf(j.oneOfType([j.shape(Me), xe])).isRequired;
  var ke = j.shape(Me),
    Ae = j.oneOfType([j.arrayOf(j.oneOfType([ke, xe])), ke]),
  ...
  (e.withYMaps = k),
    ...
    (e.Panorama = X),
    (e.Button = ne),
    (e.FullscreenControl = re),
    (e.GeolocationControl = se),
    (e.ListBox = pe),
    (e.ListBoxItem = ue),
    (e.RouteButton = le),
    (e.RouteEditor = ye),
